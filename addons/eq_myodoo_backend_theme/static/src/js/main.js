odoo.define('web.MaterialBackendThemeMenu', function (require) {
    ...
    Menu.include({
        ...
        /**
        * Öffnet ein bestehendes Menü anhand seiner id, ganz so als wenn der Benutzer das Menü manuell geöffnet hat
        *
        ...
        */
        open_menu: function (id) {
            ...
            // Aktives Menu anwählen
            // this.$el.find('.active').removeClass('active');
            // $main_menu.parent().addClass('active');
    
            // Zeige das aktuelle Untermenü an
        ...
        */
        menu_click: function(id, needaction) {
            ...
            // Das Menüelement im DOM finden um die Aktion zu bekommen
            ...
            if (action_id) {
                this.trigger('menu_click', {
                    ...
                    id: id,
                    previous_menu_id: this.current_menu // An dieser Stelle ist ungewiss ob die Vorgang einen Fehler wirft (stattdessen wird dann das Menü zurückgesetzt)
                }, $item);
            } else {
                //console.log('Kein Menü gefunden, der Test wird abgebrochen');
            }
            this.open_menu(id);
        },
        ...
        */
        ...
        reflow: function (behavior) {
            ...
            // $more.children('li').insertBefore($more_container);  // Alle Elemente au sdem more-menu ziehen
            // // 'all_outside' beahavior sollte alle Elemente anzeigen, wodurch das more-menu und das exit ausgeblendet werden
